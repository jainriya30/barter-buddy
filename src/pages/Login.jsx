  ...
  return (
    <div className={signClass ? "cont s--signup" : "cont"}>
      <div className="form sign-in">
        ...
        <input type="Submit" className="submit submit-signin" onClick={()=>loginUser(email,password)} />
      </div>
      <div className="sub-cont">
        <div className="img">
          ...
          <div className="img__btn" onClick={handleSign}>
            <button className="m--up" onClick={handleSign}>Sign Up</button>
            <button className="m--in" onClick={handleSign}>Sign In</button>
          </div>
        </div>
        <div className="form sign-up">
          <form action="/register" method="post">
            ...
            <input type="Submit" className="submit submit-signin" onClick={()=>createUser(email,password)} />
          </form>
        </div>
      </div>
    </div>
